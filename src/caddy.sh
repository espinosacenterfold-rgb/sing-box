...
# for more info, see https://github.com/espinosacenterfold-rgb/sing-boxs_core/caddy-auto-tls/
# 不要编辑这个文件 #
# 更多相关请阅读此文章: https://github.com/espinosacenterfold-rgb/sing-boxs_core/caddy-auto-tls/
...
reverse_proxy https://$proxy_site {
    ...
    [[ $1 != "new" && $1 != 'proxy' ]] && {
        [[ ! -f ${is_caddy_site_file}.add ]] && echo "# see https://github.com/espinosacenterfold-rgb/sing-boxs_core/caddy-auto-tls/" >${is_caddy_site_file}.add
    }
}
